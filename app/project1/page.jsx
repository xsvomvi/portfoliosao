...
export default function Page4() {
  return (
    <FullPageProject
      ...
      description="* designed and coded a café website based on owner interviews, competitive research and user testing. iterated on ui/ux through feedback and built the site using html, css and javascript, focusing on a minimal, modern design aligned with ichi's instagram aesthetic. the site provides menu access, contact info, opening hours and a foundation for future online ordering."
